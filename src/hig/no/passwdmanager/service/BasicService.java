 ...
 * 
 */
public class BasicService extends NfcService {
	 ...
	 */
	public BasicService(IsoDep picc) throws CardServiceException {
		super(picc);
		try {
	 ...
	 * @return the EAC key pair used by the host
	 * @throws CardServiceException
	 *             on error
	 */
	 ...
	 * the driving license. In short: (a) feed the sequence of terminal
