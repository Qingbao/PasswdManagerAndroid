...
import hig.no.passwdmanager.certificate.TerminalCVCertificateDirectory;
import hig.no.passwdmanager.lds.DG_14_FILE;
import hig.no.passwdmanager.lds.DG_15_FILE;
import hig.no.passwdmanager.lds.DG_1_FILE;
import hig.no.passwdmanager.lds.DG_COM;
import hig.no.passwdmanager.lds.DG_SOD;
import hig.no.passwdmanager.lds.DocumentSigner;
import hig.no.passwdmanager.lds.FileStructure;
import hig.no.passwdmanager.lds.SecurityObjectIndicator;
import hig.no.passwdmanager.lds.SecurityObjectIndicatorDG14;
import hig.no.passwdmanager.lds.SecurityObjectIndicatorDG15;
